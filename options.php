...
function optionsframework_options() {
	...
	$imagepath =  get_template_directory_uri() . '/theme-images/';
	...
	$options[] = array(
		'name' => __( 'Site Logo', 'theme-logo' ),
		'desc' => __( 'Theme Logo', 'theme-logo' ),
		'id' => 'theme_logo',
		'type' => 'upload'
	);

	$options[] = array(
		'name' => __( 'Site Footer Logo', 'theme-footer-logo' ),
		'desc' => __( 'Theme Footer Logo', 'theme-footer-logo' ),
		'id' => 'theme_footer_logo',
		'type' => 'upload'
	);

	$options[] = array(
		'name' => __( 'Barrel Price', 'theme-barrel-price' ),
		'desc' => __( 'Show Barrel Price', 'theme-barrel-price' ),
		'id' => 'show_barrel_checkbox',
		'std' => '1',
		'type' => 'checkbox'
	);
